...
//Solution: using two pointers left and right, maintain the area that [left, right]
//has the same number of characters as T
class Solution {
public:
  string minWindow(string S, string T) {
    ...
    for(int i = 0; i < n2; ++i)
      counts[ T[i] ]++;
    // left and right is two points. begin and end records the index result
